    ...
    <el-col :xs="24" :sm="24" :md="14" :lg="15" :xl="15" class="auth-container">
      <div class="auth-box">
        <div class="auth-header">
          ...
          <div style="margin-top: 60px;display: flex;align-items: center;justify-content: space-between;">
            <div>
              <el-switch
                  v-model="auth_type"
                  inline-prompt
        ...
        <div>
          <el-button type="primary" style="width: 100%;" size="large">GitLab OAuth 登陆</el-button>
        </div>
        <div class="auth-footer-container">
          <div>
            <span>忘记密码?</span>
            <strong style="color: cadetblue;" @click="$router.push('/auth/forget-password')"> 找回密码</strong>
          </div>
          <div>
            <div>
              没有账户? <strong style="color: cadetblue;" @click="$router.push('/auth/register')">创建一个</strong>
            </div>
          </div>
        </div>
      </div>
